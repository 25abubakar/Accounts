...
public interface IAttendanceService
{
    ...
    Task<DailyAttendanceReportDto> GetStaffAttendanceReportAsync(string identityUserId, DateOnly dateFrom, DateOnly dateTo, CancellationToken cancellationToken = default);
