...
[Migration("20260730120000_AlignAttendanceEvaluationWithRuleWindows")]
public sealed class AlignAttendanceEvaluationWithRuleWindows : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            BEGIN
                ...
                SELECT TenantId, PersonId, AttendanceDate, @Absent, 0, @AsOfUtc, @AsOfUtc
                FROM Missing
