...
[Migration("20260731017000_CompleteProcessReportOnFinalApproval")]
public sealed class CompleteProcessReportOnFinalApproval : Migration
{
                ...
                BEGIN
                    ...
                    BEGIN
                        ...
                        BEGIN
                            ...
                            -- The final authority completes the workflow with this
                            -- approval. Do not assign the same authority a second
                            -- Pending Resolution task.
                        ...
                        ELSE
                            SET @NextStatusCode=CASE
                                ...
                                ELSE N'FORWARDED' END;
                    END
                    ELSE IF @ActionCode=N'RESOLVE'
                    BEGIN
                        -- Retained for reports that entered Pending Resolution
    ...
    {
        // Forward-only workflow correction.
    }
}
