...
namespace Accounts.Migrations
{
    ...
    [Migration("20260903080457_AddPayScaleTadaLeaveAndPackageRefs")]
    partial class AddPayScaleTadaLeaveAndPackageRefs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounts.Models.EobiEligibility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EobiEligibilities");
                });

            modelBuilder.Entity("Accounts.Models.EobiSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("EmployeeRatePercentage")
                        .HasColumnType("decimal(9,4)");

                    b.Property<decimal>("EmployerRatePercentage")
                        .HasColumnType("decimal(9,4)");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit");

                    b.Property<decimal>("MaximumContributionBase")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Accounts.Models.PayRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FixedWorkingDays")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WorkingDaysBasis")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("Accounts.Models.PayScaleLeave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ApplicableAfter")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<decimal>("ApplicableValue")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<string>("LeaveReference")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("TenantId", "LeaveReference")
                        .IsUnique();

                    b.HasIndex("TenantId", "SalaryScaleId", "LeaveTypeId", "Name")
                        .IsUnique();

                    b.ToTable("PayScaleLeaves");
                });
            ...
            modelBuilder.Entity("Accounts.Models.PayScaleRuleRegistration", b =>
                {
                    ...
                    b.HasIndex("TenantId", "RuleType", "Name")
                        .IsUnique();

                    b.ToTable("PayScaleRuleRegistrations");
                });

            modelBuilder.Entity("Accounts.Models.PayScaleTada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TadaReference")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int>("TadaTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TadaTypeId");

                    b.HasIndex("TenantId", "TadaReference")
                        .IsUnique();

                    b.HasIndex("TenantId", "SalaryScaleId", "TadaTypeId", "Name")
                        .IsUnique();

                    b.ToTable("PayScaleTadas");
                });

            modelBuilder.Entity("Accounts.Models.PayrollBenefitDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsEobiContributory")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("PayrollBenefitDefinitions");
                });

            modelBuilder.Entity("Accounts.Models.PayrollBenefitParameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "BenefitRuleId", "Name")
                        .IsUnique();

                    b.ToTable("PayrollBenefitParameters");
                });
            ...
            modelBuilder.Entity("Accounts.Models.PayrollBenefitRule", b =>
                {
                    ...
                    b.Property<string>("BenefitsType")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<bool>("IsIneligible")
                        .HasColumnType("bit");

                    b.Property<decimal>("MaximumExpense")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("MaximumPh")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("MinimumPh")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<DateOnly?>("Wef")
                        .HasColumnType("date");

                    b.HasKey("Id");

                    b.HasIndex("TenantId", "BenefitReference");

                    b.HasIndex("TenantId", "Name")
                        .IsUnique();

                    b.ToTable("PayrollBenefitRules");
                });

            modelBuilder.Entity("Accounts.Models.PayrollBonusDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounts.Models.PayrollBonusDistribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BenefitParameterId")
                        .HasColumnType("int");

                    b.Property<DateTime>("CreatedOnUtc")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("DisciplinePercentage")
                        .HasColumnType("decimal(9,4)");
                    ...
                    b.HasIndex("BenefitParameterId")
                        .IsUnique();

                    b.HasIndex("TenantId", "BenefitParameterId")
                        .IsUnique();

                    b.ToTable("PayrollBonusDistributions");
                });
            ...
            modelBuilder.Entity("Accounts.Models.PayrollLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("EmployeeEobiAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("EmployerBenefitAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("EmployerEobiAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("TenantId", "PayrollRunId", "PersonId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Accounts.Models.PayrollTaxSlab", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "TaxYear", "FromAmount")
                        .IsUnique();

                    b.ToTable("PayrollTaxSlabs");
                });
            ...
            modelBuilder.Entity("Accounts.Models.SalaryPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounts.Models.SalaryScale", b =>
                {
                    ...
                    b.Property<int?>("RuleRegistrationId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounts.Models.AllowanceType", b =>
                {
                    ...
                    b.HasIndex("TenantId", "AllowanceCategory", "DisplayOrder");
            ...
            modelBuilder.Entity("Accounts.Models.PayScaleLeave", b =>
                {
                    b.HasOne("Accounts.Models.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("Accounts.Models.PayScaleTada", b =>
                {
                    ...
                    b.HasOne("Accounts.Models.TadaType", "TadaType")
                        .WithMany()
                        .HasForeignKey("TadaTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Accounts.Models.PayrollBonusDistribution", b =>
                {
                    b.HasOne("Accounts.Models.PayrollBenefitParameter", "BenefitParameter")
                        .WithOne("BonusDistribution")
                        .HasForeignKey("Accounts.Models.PayrollBonusDistribution", "BenefitParameterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Accounts.Models.PayrollLine", b =>
                {
                    b.HasOne("Accounts.Models.PayrollRun", "PayrollRun")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("Accounts.Models.SalaryPackage", b =>
                {
                    b.HasOne("Accounts.Models.PayRule", "PayRule")
                        .WithMany()
            ...
            modelBuilder.Entity("Accounts.Models.SalaryScale", b =>
                {
                    b.HasOne("Accounts.Models.PayScaleRuleRegistration", "RuleRegistration")
                        .WithMany()
                        .HasForeignKey("RuleRegistrationId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Accounts.Models.PayrollBenefitParameter", b =>
                {
                    b.Navigation("BonusDistribution");
                });
