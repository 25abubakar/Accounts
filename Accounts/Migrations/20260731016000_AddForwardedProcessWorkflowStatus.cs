...
[Migration("20260731016000_AddForwardedProcessWorkflowStatus")]
public sealed class AddForwardedProcessWorkflowStatus : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            USING (VALUES
                (N'FORWARDED', N'Forwarded for Approval', N'#0EA5E9', CONVERT(bit, 0), 15)
            ...
            WHEN NOT MATCHED THEN
                INSERT(Code, Name, ColorCode, IsTerminal, DisplayOrder)
    ...
    {
        // Forward-only workflow status correction.
    }
}
