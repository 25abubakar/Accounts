...
namespace Accounts.Migrations
{
    ...
    [Migration("20260508120000_AddPersonProfileView")]
    partial class AddPersonProfileView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounts.Models.Person", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate").ValueGeneratedOnAdd().HasColumnType("datetime2").HasDefaultValueSql("GETDATE()");
                    ...
                    b.Property<string>("Gender").HasMaxLength(20).HasColumnType("nvarchar(20)");
                    b.Property<string>("IdentityUserId").IsRequired().HasMaxLength(450).HasColumnType("nvarchar(450)");
                    b.Property<string>("LoginId").IsRequired().HasMaxLength(30).HasColumnType("nvarchar(30)");
                    b.Property<string>("MaritalStatus").HasMaxLength(50).HasColumnType("nvarchar(50)");
                    b.Property<string>("Phone").HasMaxLength(50).HasColumnType("nvarchar(50)");
                    b.Property<string>("ProfilePhotoUrl").HasMaxLength(500).HasColumnType("nvarchar(500)");

                    b.HasKey("PersonId");
                    b.HasIndex("IdentityUserId").IsUnique();
            ...
            modelBuilder.Entity("Accounts.Models.PersonAddress", b =>
                {
                    ...
                    b.Property<string>("AddressLine").HasMaxLength(250).HasColumnType("nvarchar(250)");
                    b.Property<string>("AddressType").IsRequired().HasMaxLength(20).HasColumnType("nvarchar(20)");
                    ...
                    b.Property<string>("PostalCode").HasMaxLength(20).HasColumnType("nvarchar(20)");
                    b.Property<string>("Province").HasMaxLength(100).HasColumnType("nvarchar(100)");

                    b.HasKey("AddressId");
                    b.HasIndex("PersonId", "AddressType").IsUnique();
            ...
            modelBuilder.Entity("Accounts.Models.Staff", b =>
                {
                    ...
                    b.Property<string>("Email").HasMaxLength(150).HasColumnType("nvarchar(150)");
                    b.Property<string>("FullName").IsRequired().HasMaxLength(150).HasColumnType("nvarchar(150)");
                    b.Property<DateTime>("JoiningDate").ValueGeneratedOnAdd().HasColumnType("datetime2").HasDefaultValueSql("GETDATE()");
                    b.Property<Guid?>("PersonId").HasColumnType("uniqueidentifier");
                    b.Property<string>("Phone").HasMaxLength(50).HasColumnType("nvarchar(50)");
                    b.Property<string>("PhotoUrl").HasMaxLength(500).HasColumnType("nvarchar(500)");
                    b.Property<Guid?>("VacancyId").HasColumnType("uniqueidentifier");

                    b.HasKey("StaffId");
                    b.HasIndex("PersonId").IsUnique().HasFilter("[PersonId] IS NOT NULL");
                    b.HasIndex("VacancyId").IsUnique().HasFilter("[VacancyId] IS NOT NULL");
            ...
            modelBuilder.Entity("Accounts.Models.Vacancy", b =>
                {
                    ...
                    b.Property<bool>("IsFilled").ValueGeneratedOnAdd().HasColumnType("bit").HasDefaultValue(false);
                    ...
                    b.Property<string>("VacancyCode").IsRequired().HasMaxLength(50).HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Accounts.Models.OrganizationTree", b =>
                {
                    b.HasOne("Accounts.Models.OrganizationTree", "Parent").WithMany("Children").HasForeignKey("ParentId").OnDelete(DeleteBehavior.Restrict);
                    b.Navigation("Parent");
                });

            modelBuilder.Entity("Accounts.Models.PersonAddress", b =>
                {
                    b.HasOne("Accounts.Models.Person", "Person").WithMany("Addresses").HasForeignKey("PersonId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.Navigation("Person");
                });

            modelBuilder.Entity("Accounts.Models.Staff", b =>
                {
                    b.HasOne("Accounts.Models.Person", "Person").WithOne("Staff").HasForeignKey("Accounts.Models.Staff", "PersonId").OnDelete(DeleteBehavior.SetNull);
                    b.HasOne("Accounts.Models.Vacancy", "Vacancy").WithOne("Staff").HasForeignKey("Accounts.Models.Staff", "VacancyId").OnDelete(DeleteBehavior.SetNull);
                    b.Navigation("Person");
            ...
            modelBuilder.Entity("Accounts.Models.Vacancy", b =>
                {
                    b.HasOne("Accounts.Models.OrganizationTree", "Organization").WithMany().HasForeignKey("OrganizationId").OnDelete(DeleteBehavior.Restrict).IsRequired();
            ...
            modelBuilder.Entity("Accounts.Models.OrganizationTree", b => { b.Navigation("Children"); });
            modelBuilder.Entity("Accounts.Models.Person", b => { b.Navigation("Addresses"); b.Navigation("Staff"); });
            modelBuilder.Entity("Accounts.Models.Vacancy", b => { b.Navigation("Staff"); });
